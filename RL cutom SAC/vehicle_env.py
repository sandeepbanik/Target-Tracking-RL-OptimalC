...
class VehicleEnv(gym.Env):
    ...
    def reset(self, seed=None, options=None):
        ...
        dist = self.np_random.uniform(12.0, 15.0)
    ...
    def f_dyn_opc(
        ...
        self.state[3] += np.clip(vel_c*self.dt, -self.max_acceleration, self.max_acceleration) # Saturate acceleration
    ...
    def step(self, action):
        ...
        reward = -dist - 0.1*np.linalg.norm([target_v,target_sa])  # Distance + control penalty
